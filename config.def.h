 ...
 * - dwm-backlight-20241021-351084d.diff
 * */
...
static const char *fonts[]          = { "monospace:size=16", "Hack Nerd Font Mono:size=16", "NotoColorEmoji:pixelsize=14:antialias=true:autohint=true"  };
